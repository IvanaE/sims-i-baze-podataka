...
from view.add_model_form import AddModelForm
...
class ListDock(QtWidgets.QDockWidget):
    ...
    def __init__(self, title, parent, handleModelClick):
        ...
        self.addModelButton.setIcon(QtGui.QIcon('view/icons/icons8-add-image-96.png'))
        ...
        self.deleteModelButton.setIcon(QtGui.QIcon('view/icons/icons8-delete-96.png'))
