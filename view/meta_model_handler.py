...
class MetaModelHandler:
    ...
    def load(self):
        ...
        file = open(QDir.currentPath() + '/data/metaModels.txt', 'r')
        ...
        file = open(QDir.currentPath() + '/data/metaData.txt', 'r')
    ...
    def save(self):
        ...
        file = open(QDir.currentPath() + '/data/metaModels.txt', 'w')
        ...
        file = open(QDir.currentPath() + '/data/metaData.txt', 'w')
